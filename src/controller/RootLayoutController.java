...
public class RootLayoutController {
	...
	public void showOnlineHelp() {
		...
		alert.setTitle("Meine Kontakte");
		alert.setHeaderText("Online Hilfe");
		alert.setContentText("Webside: https://code.makery.ch");
	...
	public void showAutor() {
		...
		alert.initOwner(mainApp.getPrimaryStage());
		alert.setTitle("Meine Kontakte");
		alert.setHeaderText("Informationen");
		alert.setContentText("Autor: Marco Jakob \n \n Überarbeitet: Suleika Erne und Remo Misteli \n Juni 2019");
